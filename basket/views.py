...
def view_basket(request):
    """ A view for the contents of the basket """
    return render(request, 'basket/basket.html')

def add_to_basket(request, item_id):
    """ adding specified products to the basket """
...
def modify_basket(request, item_id):
    """to update the basket and its contents"""
...
def remove_from_basket(request, item_id):
    """Remove an item or items from the shopping basket"""
